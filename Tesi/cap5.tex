...
quantificabile a priori, senza conoscere i casi di uso specifici, quindi per il momento è stato ignorato. Facendo test in locale si può capire come reagisce il software quando le istanze aumentano e il carico dei dati si incrementa. Si può dire che l'obbiettivo dei test è capire se il software gestisce bene l'aumento dei nodi, che comporta a seconda del comando un aumento della complessità dell'architettura e permette di valutare la scalabilità del programma. 
